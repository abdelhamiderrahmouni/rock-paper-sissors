...
var playerRounds = document.getElementById('playerRounds');
var oponentRounds = document.getElementById('oponentRounds');
...
function updateRound(){
    int = parseInt(round.textContent, 10);
    int++;
    round.innerText = int;
}
...
function updateScore(s) {
    if (s === 0) {
        ...
        if (playerScoreInt === 3) {
            updateRound();
            int = parseInt(playerRounds.textContent, 10);
            int++;
            playerRounds.innerText = int;
            gameOver(0);
        }
    } else if (s === 1) {
        ...
        if (oponentScoreInt === 3) {
            updateRound();
            int = parseInt(oponentRounds.textContent, 10);
            int++;
            oponentRounds.innerText = int;
            gameOver(1);
        }
    }
}
...
function gameOver(r) {
    ...
    var playerRoundsDisplay = document.getElementById('playerRoundsDisplay');
    var oponentRoundsDisplay = document.getElementById('oponentRoundsDisplay');
    playerRoundsDisplay.innerText = playerRounds.textContent;
    oponentRoundsDisplay.innerText = oponentRounds.textContent;
    if (r === 0) {
